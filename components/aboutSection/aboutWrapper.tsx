...
export function AboutWrapper({}) {
  const [text, setText] = useState({
    main: "Featured Work",
    para: `Building high-end, pixel-perfect websites for agencies and individuals, while specializing in e-commerce solutions for large corporations and creating high-quality rebuilds in my free time.`,
  });
  useEffect(() => {
    if (!isDesktop()) {
      setText({
